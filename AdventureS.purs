...
exec_command bedRoom "Pick up note" = "do something" --Where we actually go to pick up the note
exec_command kitchen "Talk to Cody" = "do something" --The talk command make sure you are talking to who you can talk(expand if necessary)
exec_command kitchen "Tell Cody " = "do something " --if you tell cody then the end case for that will be very different.
exec_command livingRoom "Tell Max " = "do something" -- end game for this 
exec_command work "Tell Ellen" = "do soemthing" --then do it
exec_command work "Tell Emily" = "do something"
exec_command kitchen "Get Coffee" = "do something" 
exec_command work "Call Emily" = "do something" 